        ...
        <div className="flex justify-center items-center min-h-[10vh]">
            ...
            >
                <div className="flex flex-col">
                    ...
                    <input
                        className="w-full p-2 border rounded-md bg-white text-black placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-cyan-500"
                        type="text"
                        name="name"
                        value={name}
                ...
                <div className="flex flex-col">
                    ...
                    <select
                        ...
                        value={category}
                        className="w-full p-2 border rounded-md bg-white text-gray-700 focus:outline-none focus:ring-2 focus:ring-cyan-500">
                ...
                <div className="flex justify-center">
                    <button
                        type="submit"
                        className="w-full bg-cyan-500 text-white font-bold py-2 rounded-md hover:bg-blue-500 transition"
                    >
                        Submit
                    </button>
                </div>
